...
So to confirm the behavior, we also took the earlier version of the code from the repository and ran the dead toggle smell detection algorithm and we found the following results. This prove that algorithm was indeed able to detect smells in the actual code.
